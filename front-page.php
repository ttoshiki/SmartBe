            ...
            <li class="front-page__aboutTextItem">
                <div>
                    ...
                    <p class="front-page__aboutText">
                        集客アカデミーやスクールには、累計500人を超える同じ志を持った仲間が待っています。<br />
  ...
  <section class="front-page__service">
    ...
    <ul class="front-page__serviceList">
        <li class="front-page__serviceItem">
			...
			<div class="m_botton"><a href="academy" target="_blank" class="">詳細はこちら</a></div>
        </li>
        <li class="front-page__serviceItem">
			...
			<div class="m_botton"><a href="seminar-list" target="_blank" class="">詳細はこちら</a></div>
        </li>
        <li class="front-page__serviceItem">
			...
			<div class="m_botton"><a href="https://peraichi.com/landing_pages/view/smart8online/" target="_blank" class="">詳細はこちら</a></div>
        </li>
        <li class="front-page__serviceItem">
			...
			<div class="m_botton"><a href="inflady" target="_blank" class="">詳細はこちら</a></div>
        </li>
        <li class="front-page__serviceItem">
			...
			<div class="m_botton"><a href="https://smartbeauty-expo.com/" target="_blank" class="">詳細はこちら</a></div>
        </li>
    </ul>
  </section>
  <section class="front-page__voice">
      <h1 class="front-page__voiceHeading">受講生の声</h1>
      <p class="front-page__voiceText">累計500人以上の<br class="sp">受講生の喜びの声をご紹介します</p>
