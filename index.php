...
<div id="main_col">
  ...
  <?php if (have_posts()) : ?>
  <h2 id="archive_headline" class="headline rich_font">
    <?php printf(__('Search results for %s', 'tcd-w'), get_search_query()); ?></h2>
  <?php else: ?>
  ...
  <?php } elseif (is_day()) { ?>
  <h2 id="archive_headline" class="headline rich_font">
    <?php printf(__('Archive for &#8216; %s &#8217;', 'tcd-w'), get_the_time(__('F jS, Y', 'tcd-w'))); ?></h2>

  <?php } elseif (is_month()) { ?>
  <h2 id="archive_headline" class="headline rich_font">
    <?php printf(__('Archive for &#8216; %s &#8217;', 'tcd-w'), get_the_time(__('F, Y', 'tcd-w'))); ?></h2>

  <?php } elseif (is_year()) { ?>
  <h2 id="archive_headline" class="headline rich_font">
    <?php printf(__('Archive for &#8216; %s &#8217;', 'tcd-w'), get_the_time(__('Y', 'tcd-w'))); ?></h2>

  <?php } elseif (is_author()) { ?>
  <?php global $wp_query; $curauth = $wp_query->get_queried_object(); //get the author info?>
  <h2 id="archive_headline" class="headline rich_font">
    <?php printf(__('Archive for the &#8216; %s &#8217;', 'tcd-w'), $curauth->display_name); ?></h2>
