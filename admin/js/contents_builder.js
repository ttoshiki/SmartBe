jQuery(document).ready(function($){
	...
	// 記事リスト タイプ変更
	$('#contents_builder').on('change', '.cb_content-blog_list .cb_list_type-radios :radio', function(){
console.log(this,this.checked)
		if (this.checked) {
			var $container = $(this).closest('.cb_content-blog_list');
console.log($container)
			$container.find('div[class*="cb_list_type-content-"]').hide();
			$container.find('.cb_list_type-content-' + this.value).show();
console.log($container.find('.cb_list_type-content-' + this.value))
		}
	});
	$('#contents_builder .cb_content-blog_list .cb_list_type-radios :radio:checked').trigger('change');
});
