...
<img src="<?php echo get_template_directory_uri(); ?>/img/instructor_recruitment_header.jpg" alt="" class="instructor_recruitment_header pc tab">
<img src="<?php echo get_template_directory_uri(); ?>/img/instructor_recruitment_header-sp.jpg" alt="" class="instructor_recruitment_header sp">

<div class="instructorRecruitment">
    <div class="instructorRecruitment__inner">
        <section class="instructorRecruitment__section">
            <h1 class="instructorRecruitment__heading">ただ今、Smart Beでは<br class="sp">セミナー講師を募集しています。</h1>
        ...
        <section class="instructorRecruitment__section">
            <h1 class="instructorRecruitment__heading">SNSで広く拡散され<br class="sp">認知度が高まります。</h1>
        ...
        <a href="<?php bloginfo('template_directory'); ?>/assets/recruit_documents.pdf" class="iconWithButton"　 target="_blank">
